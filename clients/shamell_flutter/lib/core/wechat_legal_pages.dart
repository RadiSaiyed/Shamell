...
class WeChatTermsOfServicePage extends StatelessWidget {
  const WeChatTermsOfServicePage({super.key});
...
• يستخدم Shamell تسجيل الدخول عبر رقم الهاتف (OTP).
...
- Shamell uses phone‑number OTP sign‑in.
...
class WeChatPrivacyPolicyPage extends StatelessWidget {
  const WeChatPrivacyPolicyPage({super.key});
...
• عند استخدام ميزات مثل \"الأشخاص القريبون\" قد تتم مشاركة موقعك مع الخادم لتقديم النتائج.
...
- Features like “People nearby” may share your location with the server to return results.
