...
class _ShamellNewMessageNotificationPageState
  ...
  Future<void> _load() async {
    ...
    try {
      final cfg =
          await _store.loadNotifyConfig(baseUrlOverride: widget.baseUrl);
      if (!mounted) return;
      setState(() {
                ...
                _switchRow(
                  ...
                  onChanged: controlsEnabled
                      ? (v) async {
                          ...
                          setState(() => _dnd = v);
                          try {
                            await _store.setNotifyDndEnabled(
                              v,
                              baseUrlOverride: widget.baseUrl,
                            );
                          } catch (_) {}
