...
class TaxiMapWidget extends StatelessWidget {
  final LatLng center;
  ...
  Widget build(BuildContext context) {
    // Always use the FlutterMap + tile-based renderer.
    // The base tiles can come from OpenStreetMap (default) or TomTom Map Display API
    // depending on kOsmTileUrl / kTomTomMapKey configuration.
    final String baseTileUrl = kTomTomMapKey.isNotEmpty
        // Prefer TomTom Map Display tiles whenever a TOMTOM_MAP_KEY
    ...
    return fm.FlutterMap(
      options: fm.MapOptions(
        ...
        onTap: (tapPos, latlng) => onTap?.call(LatLng(latlng.latitude, latlng.longitude)),
      ),
      children: [
        fm.TileLayer(
