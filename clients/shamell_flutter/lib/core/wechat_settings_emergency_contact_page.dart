...
class WeChatSettingsEmergencyContactPage extends StatefulWidget {
  const WeChatSettingsEmergencyContactPage({super.key});

  @override
  State<WeChatSettingsEmergencyContactPage> createState() =>
      _WeChatSettingsEmergencyContactPageState();
}

class _WeChatSettingsEmergencyContactPageState
    extends State<WeChatSettingsEmergencyContactPage> {
  static const _kNameKey = 'wechat.security.emergency_contact.name';
  static const _kPhoneKey = 'wechat.security.emergency_contact.phone';
