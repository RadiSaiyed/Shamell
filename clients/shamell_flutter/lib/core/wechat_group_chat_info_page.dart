...
class WeChatGroupMemberDisplay {
  final String id;
  final String name;
  final bool isAdmin;
  final bool isMe;

  const WeChatGroupMemberDisplay({
    required this.id,
    required this.name,
    this.isAdmin = false,
    this.isMe = false,
...
class WeChatGroupChatInfoPage extends StatefulWidget {
  final String groupId;
  final String groupName;
  final Uint8List? avatarBytes;
  final List<WeChatGroupMemberDisplay> members;
  final bool isAdmin;
  final bool muted;
  final bool pinned;
  ...
  const WeChatGroupChatInfoPage({
    super.key,
    required this.groupId,
    required this.groupName,
    this.avatarBytes,
    this.members = const <WeChatGroupMemberDisplay>[],
    this.isAdmin = false,
    this.muted = false,
    this.pinned = false,
  ...
  @override
  State<WeChatGroupChatInfoPage> createState() =>
      _WeChatGroupChatInfoPageState();
}

class _WeChatGroupChatInfoPageState extends State<WeChatGroupChatInfoPage> {
  bool _busy = false;
  late bool _muted;
  late bool _pinned;
  ...
  Future<void> _openGroupNotice() async {
    ...
    final res = await Navigator.of(context).push<String?>(
      MaterialPageRoute(
        builder: (_) => _WeChatGroupNoticePage(
...
class _WeChatGroupNoticePage extends StatefulWidget {
  final String groupName;
  final String initialNotice;
  final bool canEdit;

  const _WeChatGroupNoticePage({
    required this.groupName,
  ...
  @override
  State<_WeChatGroupNoticePage> createState() => _WeChatGroupNoticePageState();
}

class _WeChatGroupNoticePageState extends State<_WeChatGroupNoticePage> {
