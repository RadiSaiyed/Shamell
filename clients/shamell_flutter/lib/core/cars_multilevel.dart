...
class CarrentalCarmarketMultiLevelPage extends StatefulWidget {
  ...
  @override
  State<CarrentalCarmarketMultiLevelPage> createState() => _CarrentalCarmarketMultiLevelPageState();
}

class _CarrentalCarmarketMultiLevelPageState extends State<CarrentalCarmarketMultiLevelPage> {
  bool _loading = true;
  String _error = '';
  ...
  Future<void> _mutateCarsRole({required String role, required bool grant}) async {
