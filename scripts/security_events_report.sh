...
THRESHOLDS="${SECURITY_ALERT_THRESHOLDS:-header_session_auth_rejected.blocked:3,device_login_approve.blocked:5,device_login_redeem.blocked:5,biometric_login.blocked:10,biometric_token_rotate.failed:1,auth_rate_limit_exceeded.blocked:30,chat_protocol_downgrade.blocked:1,chat_key_bundle_policy.blocked:1,chat_key_register_policy.blocked:1}"
