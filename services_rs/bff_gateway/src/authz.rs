...
mod tests {
    ...
    fn state(
        ...
        AppState {
            ...
            geo_lookup_base_url: crate::state::DEFAULT_GEO_LOOKUP_BASE_URL.to_string(),
            http: Client::new(),
            auth: None,
    ...
    fn parse_roles_requires_role_secret_when_configured() {
        ...
        headers.insert("x-auth-roles", HeaderValue::from_static("admin,seller"));
