...
class AgricultureOperatorPage extends StatefulWidget {
  final String defaultBaseUrl;
  const AgricultureOperatorPage({
    super.key,
  ...
  @override
  State<AgricultureOperatorPage> createState() => _AgricultureOperatorPageState();
}

class _AgricultureOperatorPageState extends State<AgricultureOperatorPage> {
  ...
  Future<void> _health() async {
    ...
    try {
      final r = await http.get(
        Uri.parse('$_baseUrl/agriculture/health'),
  ...
  Future<void> _loadListings() async {
    ...
    try {
      final uri = Uri.parse('$_baseUrl/agriculture/listings_cached');
