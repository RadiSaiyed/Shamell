...
class _EquipmentCalendarPageState extends State<EquipmentCalendarPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final uri = Uri.parse('$_base/equipment/calendar/${widget.equipmentId}')
      ...
      if (r.statusCode == 200) {
        ...
        if (body is Map && body['days'] is List) {
          ...
          _blocks = body['blocks'] is List
              ? body['blocks'] as List<dynamic>
              : const [];
        }
      } else {
            ...
            child: StatefulBuilder(builder: (context, setSheet) {
              Future<void> submit() async {
                ...
                try {
                  ...
                  final r = await http.post(
                      Uri.parse(
                          '$_base/equipment/availability/${widget.equipmentId}'),
              ...
              return SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    const Text('Add hold / maintenance',
  ...
  Widget build(BuildContext context) {
    ...
    final items = List.generate(weekdayOffset + totalDays, (i) {
      ...
      final iso = DateTime(_month.year, _month.month, day)
          .toIso8601String()
          .split('T')
          .first;
      final data = _days
              .cast<Map?>()
              .firstWhere((d) => d?['date'] == iso, orElse: () => null) ??
          {};
              ...
              children: [
                ...
                GridView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final color = itm['color'] is Color
                        ? itm['color'] as Color
                        : Colors.transparent;
