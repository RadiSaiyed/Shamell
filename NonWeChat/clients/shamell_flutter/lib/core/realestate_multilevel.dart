...
class RealestateMultiLevelPage extends StatefulWidget {
  ...
  @override
  State<RealestateMultiLevelPage> createState() =>
      _RealestateMultiLevelPageState();
}
...
class _RealestateMultiLevelPageState extends State<RealestateMultiLevelPage> {
  ...
  bool get _isReOperator {
    return _roles.contains('operator_realestate') ||
        _operatorDomains.contains('realestate');
  }
  ...
  Widget build(BuildContext context) {
    ...
    final body = ListView(
      ...
      children: [
        Row(
          children: [
            Icon(Icons.home_work_outlined, color: Tokens.colorHotelsStays),
              ...
              children: [
                if (_isReOperator)
                  Chip(
                    ...
                    backgroundColor:
                        Tokens.colorHotelsStays.withValues(alpha: .16),
                    shape: StadiumBorder(
                      side: BorderSide(
