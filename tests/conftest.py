...
def app():
    """
    Import the BFF FastAPI app once per test session.
    """
    from apps.bff.app.main import app as bff_app
...
def client(app):
    """
    Synchronous TestClient for calling the BFF.
    """
...
@pytest.fixture()
def operator_auth() -> _DummyAuth:
    """
    Operator auth helper (used together with role-mocking).
    """
